...
En la Figura \ref{fig:arquitectura}, se puede observar la arquitectura general del sistema.

\begin{figure}[h!]
\begin{center}
\includegraphics[width=\textwidth]{res/arquitectura}
\end{center}
...
El proceso de búsqueda de respuestas del sistema... Se puede ver un diagrama de secuencia en la Figura \ref{fig:secuencia}.
